		...
		public static $cf = array(
			'plugin' => array(
				'wpssoplm' => array(			// Plugin acronym.
					'version'     => '5.4.1-rc.1',	// Plugin version.
			...
			'form' => array(
				'plm_place_opts' => array(
					...
					'plm_place_day_sunday_close'         => 'none',
					'plm_place_day_monday_open'          => 'none',
					'plm_place_day_monday_close'         => 'none',
					'plm_place_day_tuesday_open'         => 'none',
					'plm_place_day_tuesday_close'        => 'none',
					'plm_place_day_wednesday_open'       => 'none',
					'plm_place_day_wednesday_close'      => 'none',
					'plm_place_day_thursday_open'        => 'none',
					'plm_place_day_thursday_close'       => 'none',
					'plm_place_day_friday_open'          => 'none',
					'plm_place_day_friday_close'         => 'none',
					'plm_place_day_saturday_open'        => 'none',
					'plm_place_day_saturday_close'       => 'none',
					'plm_place_day_publicholidays_open'  => 'none',
					'plm_place_day_publicholidays_close' => 'none',
					'plm_place_midday_close'             => 'none',
					'plm_place_midday_open'              => 'none',
