...
The [WPSSO Schema JSON-LD Markup add-on](https://wordpress.org/plugins/wpsso-schema-json-ld/) can use place information for the Schema Place type and its sub-types.
...
**Version 4.17.0-dev.8 (2020/08/08)**
